...
class RapList extends StatefulWidget {
  const RapList({Key? key}) : super(key: key);

  @override
  State<RapList> createState() => _RapList();
}

class _RapList extends State<RapList> {
      final Stream<QuerySnapshot> _stream =
      FirebaseFirestore.instance.collection('rapfr').snapshots();
                ...
                return Container(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Result( collection: 'rapfr_result'),
                    ),
